...
if not os.path.exists('./pts_in_hull.npy'):
    print("Error: pts_in_hull.npy file not found!")
    print("Please ensure the file exists in the current directory.")
    exit(1)

if not os.path.exists("./models/colorization_deploy_v2.prototxt"):
    print("Error: colorization_deploy_v2.prototxt file not found!")
    print("Please ensure the file exists in ./models/ directory.")
    exit(1)

if not os.path.exists("./models/colorization_release_v2.caffemodel"):
    print("Error: colorization_release_v2.caffemodel file not found!")
    print("Download And place it in the ./models/ directory.")
    exit(1)
...
class Window(Frame):
    def __init__(self, master=None, logo_img=None):
        ...
        self.image3 = None
        if logo_img:
            label1 = Label(self, image=logo_img)
